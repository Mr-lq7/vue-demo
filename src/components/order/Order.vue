  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderlist" stripe border style="width: 100%">
        ...
        <el-table-column :width=width  prop="order_id" label="订单ID" max_width ="10%"></el-table-column>
        ...
        <el-table-column prop="express_number" label="快递号"></el-table-column>
...
export default {
  ...
  methods: {
    async getOrderList() {
      ...
      this.orderlist = []
      for(var i = be; i < x; ++i)
        this.orderlist.push(data.data.orders[i]);
